...
void pantalla6() {
  ...
  fill(255);
  textSize(46);
  text("EL MINISTERIO DEL PRÍNCIPE", 16, 56 + scroll + ondaY);
  textSize(24);
  if (Tiping6 < desc6.length() - 1) {
  Tiping6 += 2;
  }
  text(desc6.substring(0, Tiping6), 232, 80 + scroll, 400, 350);
